...
# -*- coding: utf-8 -*-
"""
微模板构建原始单页 PPT：校验 charts/_rels 引用的 embeddings 必须为 .xlsb，缺失即报错；打包 template 为 pXX-original.pptx；日志统一到 pXX/logs。
"""
